    ...
    def run_chain(self, target_pot, loop_callback, reached_callback):
        ...
        def motion_loop():
            ...
            while self.motion_running and direction:
                ...
                if (
                    (direction == "forward" and (active_pot + offset) % num_pots == target_pot) # One pot before
                    or (direction == "reverse" and (active_pot - offset) % num_pots == target_pot) # One pot before
